...
static char *font2[] ={ "mononoki Nerd Font:pixelsize=17:antialias=true:autohint=true"};
//static char *font2[] = { "Iosevka Nerd Font :pixelsize=17:antialias=true:autohint=true" };
static char *font3[] = { "blobmoji :pixelsize=15:antialias=true:autohint=true" }; //enable this if u have libxft-bgra and blobmoji font!
